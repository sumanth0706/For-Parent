...
<!-- plugins:css -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/iconfonts/mdi/css/materialdesignicons.min.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/css/vendor.bundle.base.css">
<!-- endinject -->
<!-- inject:css -->
<link rel="stylesheet"
...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/assets/css/multi.min.css">
						...
						$("#projects")
								.change(
										function() {
											...
											var jwt = document
													.getElementById('jwt').value;
											$
													.post(
															'${pageContext.request.contextPath}/login/features',
															{
																project : project,
																jwt : jwt
															},
					...
					<li class="nav-item nav-profile dropdown"><a
							...
							<div class="nav-profile-img">
								...
								<c:choose>
									<c:when test="${user.user_id=='admin'}">
										<img
											src="${pageContext.request.contextPath}/assets/img/faces/jiten.jpg"
											alt="image">
									</c:when>
									<c:when test="${user.user_id=='vaibhav'}">
										<img
											src="${pageContext.request.contextPath}/assets/img/faces/face.png"
											alt="image">
									</c:when>
									<c:when test="${user.user_id=='abhishek'}">
										<img
											src="${pageContext.request.contextPath}/assets/img/faces/face.png"
											alt="image">
									</c:when>
									<c:when test="${user.user_id=='test'}">
										<img
											src="${pageContext.request.contextPath}/assets/img/faces/face.png"
											alt="image">
									</c:when>
						...
						<div class="dropdown-menu navbar-dropdown"
							...
							<a class="dropdown-item" href="#"> <i
								class="mdi mdi-account-circle mr-2 text-success"></i> Profile
							</a>
				...
				<ul class="nav">
					<li class="nav-item nav-profile"><a href="#" class="nav-link">
							...
							<div class="nav-profile-text d-flex flex-column">
								<span class="font-weight-bold mb-2">${user.user_id}</span> <span
									class="text-secondary text-small">Application User</span>
							</div> <i class="mdi mdi-bookmark-check text-success nav-profile-badge"></i>
					</a></li>
					<li class="nav-item"><a class="nav-link"
						href="${pageContext.request.contextPath}/login/dashboard"> <span
							class="menu-title">Feature Dashboard</span> <i
							class="mdi mdi-home menu-icon"></i>
					</a></li>
					<div id="menu">${menu_code}</div>
				</ul>
			</nav>